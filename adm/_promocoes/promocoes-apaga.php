...
if($cods != '')
{
    ...
    {
        $count = count($cods);
        atualiza_usuarios_stats($_SESSION[ADMIN_SESSION_NAME.'_cod_user'], $_SESSION[ADMIN_SESSION_NAME.'_nome'], 'Promocoes', 'Removeu', $_SESSION[ADMIN_SESSION_NAME.'_regiao'], $count);
