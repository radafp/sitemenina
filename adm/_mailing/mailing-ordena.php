<?php
if(!verifica_permissao($cod_user, $nivel, 'artistas-ordena'))
{
	echo "<script>
...
$(document).ready(function()
{
    ...
    $("#salvar").click(function()
    {
        ...
        $.ajax(
        {
            type: "POST",
            async: false,
            url: "http://"+ADMIN_URL+"/_artistas/ajax/ajaxOrdena.php", //URL de destino
            data:
            {
                ordem : ordem
            },
...
<div class="divTableLista clear drag" style="margin-top: 0;">
    <?
    $q = mysql_query("SELECT * FROM artistas ORDER BY ordem", $conexao);
    //echo mysql_error();
    $n = mysql_num_rows($q);
    if($n>0)
    {
