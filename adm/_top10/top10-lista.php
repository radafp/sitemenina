...
<div class="divTableLista clear">
    ...
    $limit_por_pag = 30;
    $q = mysql_query("SELECT * FROM top10 WHERE regiao = '{$regiao}' ORDER BY cod desc LIMIT $pag, $limit_por_pag", $conexao);
    
    $rows = mysql_query("SELECT * FROM top10 WHERE regiao = '{$regiao}'", $conexao);
