...
define('ADMIN_DEV_NOME', 'Agência Set');
define('ADMIN_DEV_SITE', 'www.agenciaset.com.br');
define('ADMIN_DEV_EMAIL', 'programacao@agenciaset.com.br');
