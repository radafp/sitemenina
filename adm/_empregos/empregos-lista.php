...
<div class="divTableLista clear">
    ...
    $limit_por_pag = 30;
    $q = mysql_query("SELECT * FROM empregos WHERE regiao = '{$regiao}' ORDER BY empregos.dataPublicacao DESC LIMIT $pag, $limit_por_pag", $conexao);
    
    $rows = mysql_query("SELECT * FROM empregos WHERE regiao = '{$regiao}'", $conexao);
