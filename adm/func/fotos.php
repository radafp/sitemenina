 ...
 * pelo m�todo uploadArquivo.
 *
 * Pode-se escolher o idioma da
 * mensagem de erro no par�metro $idioma.
 *
 ...
 * ------------------------------------------------------------------------------------------------
 * 09/03/2010	|  1.1 	 | Adicionado par�metro $tipoRetorno.
 * ------------------------------------------------------------------------------------------------
 *
 * @param integer $code
...
function codeToMessage($code, $tipoRetorno = 'js', $idioma = 'pt-br')
{
    switch ($code) {
        case UPLOAD_ERR_OK:
            ...
            $message['pt-br']['html'] = 'N�o h� nenhum erro, o arquivo enviado com sucesso.';
            break;
        case UPLOAD_ERR_INI_SIZE:
            ...
            $message['pt-br']['html'] = 'O arquivo no upload � maior do que o limite definido em upload_max_filesize no php.ini.';
            break;
        case UPLOAD_ERR_FORM_SIZE:
            ...
            $message['pt-br']['html'] = 'O arquivo ultrapassa o limite de tamanho em MAX_FILE_SIZE que foi especificado no formul�rio HTML.';
            break;
        ...
        case UPLOAD_ERR_NO_FILE:
            ...
            $message['pt-br']['html'] = 'N�o foi feito o upload do arquivo.';
            break;
        case UPLOAD_ERR_NO_TMP_DIR:
            ...
            $message['pt-br']['html'] = 'Faltando uma pasta tempor�ria. Introduzido no PHP 5.0.3.';
            break;
        ...
        case UPLOAD_ERR_EXTENSION:
            ...
            $message['pt-br']['html'] = 'O upload do arquivo foi interrompido por extens�o. Introduzido no PHP 5.2.0.';
            break;
        ...
        case 9:
            ...
            $message['pt-br']['html'] = 'O arquivo falhou na verifica��o de valida��o b�sica.';
            break;
        ...
        case 10:
            ...
            $message['pt-br']['html'] = 'O arquivo no upload � maior do que o limite definido pelo administrador.';
            break;
        ...
        case 11:
            ...
            $message['pt-br']['html'] = 'O arquivo n�o possui uma extens�o permitida pelo administrador.';
            break;
        ...
        case 14:
            ...
            $message['pt-br']['html'] = 'O diret�rio de destino n�o � um diret�rio ou possui permiss�o de escrita.';
            break;
 ...
 * uploadArquivo()
 *
 * M�todo que faz upload de um arquivo e retorna
 * o nome do arquivo armazenado em caso de sucesso
 * ou c�digo de erro em caso de falha.
 *
 * Para interpretar o c�digo de erro usa-se a
 * fun��o codeToMessage().
 *
 * exemplo:
 ...
 * Data			| Vers�o | Modifica��o
 * ------------------------------------------------------------------------------------------------
 * 29/09/2009	|  1.1 	 | Substituido a fun��o ereg por preg_match.
 * 				|   	 | ------------------------------------------------------------------------
 ...
 * ------------------------------------------------------------------------------------------------
 *
 * @param string $campoDoForm 					o nome do campo de formul�rio de upload de arquivo
 ...
 * @param integer $tamanhoMaximo 				o tamanho m�ximo do arquivo (medido em bytes)
 * @param array $extensoesPermitidas 			uma matriz contendo todos as extens�es permitidas de arquivo
 * @param integer $larguraMaxima				limite de largura de uma imagem (use null para valor padr�o)
 * @param integer $alturaMaxima					limite de altura de uma imagem (use null para valor padr�o)
 ...
 * @return string | false 						nome do arquivo armazenado em caso de sucesso ou c�digo de erro em caso de falha.
 */
function uploadArquivo($campoDoForm = '', $chaveMulti = -1, $caminhoNoServidor = '', $nomeFinalDoArquivo = '', $tamanhoMaximo = null, $extensoesPermitidas = array(), $larguraMaxima = 500, $alturaMaxima = 500, $orientacao = '', $raio = 0, $bgcolor = '')
{
    ...
    /** Teste pra saber se s�o multiplos arquivos **/
    if ($chaveMulti > -1) {
    ...
    if ((!is_uploaded_file($tmp_name)) || ($size == 0)) {
        /** arquivo falhou nas verifica��es de valida��o b�sica **/
        return 9;
    }
    ...
    if ($copy) {
        ...
        return 15; // n�o conseguiu copiar
    }
...
function insere_foto($file_name, $arquivo_temporario, $caminho, $largura_max, $altura_max)
{
    ...
    $ext = strrev($ext);
    $hoje = date('YmdHis');
    //$foto = "foto_" . $hoje . "_" . rand(1, $hoje) . "." . $ext;
    //$foto = "foto_" . $hoje . "_" . rand(1, $hoje) . "." . $ext;
    ...
    if ($foto != "") {
        ...
        if ($fileerr != 0) {
            echo " <script language=\"JavaScript1.2\"> \n";
            echo " <!-- \n";
            echo " alert('Erro no envio da imagem. Foto n�o enviada.'); \n";
            ...
            if (($largurao > $largura_max) || ($alturao > $altura_max)) 
            { //se for maior do q ta pedindo nao redimensiona
                if ($alturao < $largurao) 
                {
            ...
            if ($ext == "jpg" || $ext == "JPG" || $ext == "jpeg" || $ext == "JPEG") {
                imagejpeg($nova_copia, $arch, 85);
            } elseif ($ext == "gif" || $ext == "GIF") {
                imagegif($nova_copia, $arch, 85);
            } elseif ($ext == "png" || $ext == "PNG") {
                imagepng($nova_copia, $arch, 7);
            }
