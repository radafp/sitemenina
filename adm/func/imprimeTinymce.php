 ...
 * @return void
 */
function imprimeTinymce($name = 'texto', $value = '', $width = 610, $height = 500, $title = '')
{
?>
    <!-- TinyMCE -->
    ...
    <script type="text/javascript">
    	tinyMCE.init({
    		...
    		// Theme options
    		theme_advanced_buttons1 : "bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,copy,paste,pastetext,pasteword,|,forecolor,backcolor",
    		theme_advanced_buttons2 : "fontsizeselect,|,outdent,indent,|,undo,redo,|,link,unlink,image,code",
    ...
    <textarea title="<?=$title;?>" id="<?=$name;?>" name="<?=$name;?>" rows="15" cols="80" style="width: <?=$width;?>px; height: <?=$height;?>px" class="campoG"><?=$value;?></textarea>
<?php
}
?>
